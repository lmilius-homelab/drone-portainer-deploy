...
class PortainerAPI:
    ...
    def get_auth_headers(self):
        ...
        resp = requests.post(
            url=self.base_api_url.format('auth'),
            json=payload,
            verify=self.ssl_verify)
